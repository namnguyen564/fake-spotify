...
export default function SearchResults({ track, chooseTrack, addSong, currentRecommendationLength }) {
  ...
  return (
    <div className="flex items-center  p-2 border-b-2 border-gray-400 "  data-testid="clicking-div">
    <img src={track.albumUrl} className="w-28 h-28 object-contain cursor-pointer" onClick={handlePlay}/>
