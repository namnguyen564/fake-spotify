...
export default function SearchResults({ artist, addArtist, currentRecommendationLength }) {
  ...
  return (
    <div class="flex items-center justify-between  p-2 border-b-2 border-gray-400">
      ...
      <div class="flex-shrink-0">
        {currentRecommendationLength < 5 && (
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" onClick={handleAddArtist} className="cursor-pointer">
